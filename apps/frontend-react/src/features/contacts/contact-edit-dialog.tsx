...
import { contactEditSchema, type ContactEditValues } from './contact-schema';
...
export function ContactEditDialog({ open, onOpenChange, onSubmit, isPending, defaultValues, titleKey = 'contacts.editDetails' }: ContactEditDialogProps) {
  ...
  const form = useForm<ContactEditValues>({
    resolver: zodResolver(contactEditSchema) as never,
    defaultValues,
  });
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t('contacts.city')}</FormLabel>
                    <FormControl>
                      <Input {...field} />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t('contacts.region')}</FormLabel>
                    <FormControl>
                      <Input {...field} />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t('contacts.country')}</FormLabel>
                    <FormControl>
                      <Input {...field} />
                    </FormControl>
                    <FormMessage />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('contacts.status')}</FormLabel>
                  <Select
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="active">{t('contacts.statusActive')}</SelectItem>
                      <SelectItem value="inactive">{t('contacts.statusInactive')}</SelectItem>
                    </SelectContent>
                  </Select>
                  <FormMessage />
                </FormItem>
