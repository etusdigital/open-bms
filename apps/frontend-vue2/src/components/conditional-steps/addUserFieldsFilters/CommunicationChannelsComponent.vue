<template>
  <div class="d-flex">
    <SelectConditionalComponent
      ...
      :value="step.conditional_user_field || 'true'"
    />
...
export default class CommunicationChannelsComponent extends Vue {
  ...
  conditionalUserFields = [
    { name: 'true', value: this.$t('title.has') },
    { name: 'false', value: this.$t('title.doesNotHas') },
  ];

  listFilters = [
    { name: 'has_email', value: this.$t('title.hasEmail') },
    { name: 'has_phone', value: this.$t('title.hasPhone') },
    { name: 'has_web_push', value: this.$t('title.hasWebPush') },
    { name: 'has_mobile_push', value: this.$t('title.hasMobilePush') },
    { name: 'has_whatsapp', value: this.$t('title.hasWhatsapp') },
  ];
