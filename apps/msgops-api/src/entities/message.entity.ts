...
import { AutomationMessageAccountEntity } from './automation-message-account.entity';
...
export class MessageEntity {
  ...
  @OneToMany(() => AutomationMessageAccountEntity, (automationMessageAccount) => automationMessageAccount.message, {
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE',
    eager: true,
  })
  automationMessageAccount?: AutomationMessageAccountEntity[];

  @ManyToOne(() => AccountEntity, (account) => account.automationMessages, {
    eager: false,
    nullable: false,
  })
  ...
  @OneToMany(() => CampaignMessageEntity, (campaignMessage) => campaignMessage.message, {
    eager: false,
    nullable: true,
  })
  campaignMessage?: Array<CampaignMessageEntity>;

  @OneToMany(() => LabelsContentsEntity, (labelContent) => labelContent.message, {
    eager: false,
    nullable: true,
  })
