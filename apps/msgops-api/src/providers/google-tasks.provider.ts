...
export class GoogleTasksProvider {
  ...
  private createTaskRequest(id: number | string, waitFor: number, baseUrl: string, body?: string): { scheduleTime?: any; httpRequest: any } {
    ...
    if (body) {
      requestBodyObject.httpRequest.headers['Content-Type'] = 'application/json';
