import { BriusHttpParams } from './BriusGateway.types';

export const briusHttpParamsDefault: BriusHttpParams = {
  page: 1,
...
export const getBriusHttpParamsToString = (params: BriusHttpParams) => {
