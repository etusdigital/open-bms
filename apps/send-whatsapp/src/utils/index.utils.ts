...
import { Account, Contact, CustomFields, MapVariables, PubSubMessage } from '../interfaces';
...
export class Utils {
  ...
  mapVariables(contact: Contact, account: Account, replaceLinks: any, onlyKeyName = false): MapVariables {
    ...
    const staticVariables = ['name', 'firstName', 'lastName', 'fullName', 'email', 'hashedEmail', 'phone', 'link', 'uuid'];
