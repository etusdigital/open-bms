...
# ---------------------------------------------------------------------------
GCP_PROJECT="${GCP_PROJECT:?Set GCP_PROJECT env var (GCP project ID for Cloud Run deploy)}"
GCP_REGION="${GCP_REGION:-us-east1}"
REGISTRY="${REGISTRY:?Set REGISTRY env var (e.g. us-east1-docker.pkg.dev/<project>/<repo>)}"
